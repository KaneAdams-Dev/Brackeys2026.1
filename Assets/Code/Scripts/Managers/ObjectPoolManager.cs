...
namespace Brackeys2026
{
    public class ObjectPoolManager : MonoBehaviour
    {
        ...
        //private static void CreatePool(GameObject a_prefab, Vector3 a_pos, Quaternion a_rot) {
        //    ObjectPool<GameObject> pool = new ObjectPool<GameObject>(
        //        createFunc: () => CreateObject(a_prefab, a_pos, a_rot),
        ...
        //private static GameObject CreateObject(GameObject a_prefab, Vector3 a_pos, Quaternion a_rot) {
        //    a_prefab.SetActive(false);

        //    GameObject obj = Instantiate(a_prefab, a_pos, a_rot);
        //    a_prefab.SetActive(true);

        //    GameObject parentObject = SetParentObject();
        ...
        //private static GameObject SetParentObject() {
        //    return _gameObjectsEmpty;
        //}

        //private static T SpawnObject<T>(GameObject a_objectToSpawn, Vector3 a_spawnPos, Quaternion a_spawnRot) where T : Object {
        //    if (!_objectPools.ContainsKey(a_objectToSpawn)) {
        //        CreatePool(a_objectToSpawn, a_spawnPos, a_spawnRot);
        //    }
        ...
        //    //obj.transform.SetLocalPositionAndRotation(a_spawnPos, a_spawnRot);
        //    //obj.SetActive(true);
        ...
        //        obj.transform.SetPositionAndRotation(a_spawnPos, a_spawnRot);
        //        obj.SetActive(true);
        ...
        //public static T SpawnObject<T>(T a_typePrefab, Vector3 a_spawnPos, Quaternion a_spawnRot) where T : Component {
        //    return SpawnObject<T>(a_typePrefab.gameObject, a_spawnPos, a_spawnRot);
        //}

        //public static GameObject SpawnObject(GameObject a_objectToSpawn, Vector3 a_spawnPos, Quaternion a_spawnRot) {
        //    return SpawnObject<GameObject>(a_objectToSpawn, a_spawnPos, a_spawnRot);
        //}

        //public static void ReturnToPool(GameObject a_objectToReturn) {
        //    if (_cloneToPrefabMap.TryGetValue(a_objectToReturn, out var prefab)) {
        //        GameObject parentObject = SetParentObject();
