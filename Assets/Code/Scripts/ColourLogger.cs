...
public static class ColourLogger
{
    ...
    private static readonly string warningColour = "#F1C40F";   // Warning Yellow
    private static readonly string errorColour = "#C0392B";     // Error Red

    /// <summary>
    /// Assigns colour to class to allow differentiation in console
    /// </summary>
    /// <param name="a_className">Class to be assigned</param>
    /// <param name="a_assignedColour">Preferred colour</param>
